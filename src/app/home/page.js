  ...
  return (
    <div className="text-accent text-2xl">
      ...
      <div className="relative w-8 h-20 ml-30 mt-6">
        ...
        <div className="absolute inset-0 bg-linear-to-b from-yellow-300 via-yellow-600 to-yellow-800 rounded-t-sm rounded-b-md border-t border-yellow-200 shadow-xl overflow-hidden">
